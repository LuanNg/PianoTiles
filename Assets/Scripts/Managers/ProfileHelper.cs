...
namespace Mio.TileMaster {
    ...
    public class ProfileHelper : MonoSingleton<ProfileHelper> {
        ...
        public void SaveLocalUserData () {            
            ...
            rawUserData.achievementPropertiesValueCSV = AchievementHelper.Instance.DumpCurrentProperties();
            rawUserData.achievementUnlockedAndClaimedCSV = AchievementHelper.Instance.DumpUnlockedAndClaimedAchievements();
